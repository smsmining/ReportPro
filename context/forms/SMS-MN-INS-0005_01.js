            ...
            controls: [{
                ...
                controls:
                    [{
                        ...
                        pdf: { 1: [{ x: 181, y: 451, width: 387, height: 280 }] },
            ...
            },
            {
                ...
                controls:
                    [{
                        ...
                        pdf: { 2: [{ x: 186, y: 562, width: 387, height: 181 }] },
            ...
            },
            {
                ...
                controls:
                    [{
                        ...
                        pdf: { 3: [{ x: 190, y: 604, width: 387, height: 128 }] },
                ...
                controls:
                    ...
                    },
                    {
                        ...
                        value: [{ 'name': 'Links Height' }
                            ...
                            , { 'name': 'Sprockets', type: { value: 'Manual', disabled: true } }
                            ],
            ...
            },
            {
                ...
                controls:
                    [{
                        ...
                        pdf: { 3: [{ x: 140, y: 396, width: 437, height: 56 }] },
                        grid: { 3: [{ width: 387, height: 13, margin: 0.9 }] },
                        controls:
                            [{
                                param: 'name',
            ...
            controls: [
                {
                    ...
                    value: [
                        ...
                        { label: { value: "Left Blade Tilt Cylinder", disabled: true } },
                        { label: { value: "Right Blade Tilt Cylinder", disabled: true } },
                        { label: { value: "Left Ripper Lift Cylinder", disabled: true } },
                        { label: { value: "Right Ripper Lift Cylinder", disabled: true } },
                        { label: { value: "Left Ripper Tilt Cylinder", disabled: true } },
                        { label: { value: "Right Ripper Tilt Cylinder", disabled: true } },
                        { label: { value: "Pin Pull Cylinder", disabled: true } },
                    ],
                    controls: [
                        {
                            param: 'header',
