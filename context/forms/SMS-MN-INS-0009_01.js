...
export default SMS_MN_INS_0009_01 =
{
    guid: "00000000-0000-0000-0000-000000000012",
    name: 'Mech & Safety Inspection Wheel Loader',
    pdfname: 'SMS-MN-INS-0009_01 Mechanical and Safety Inspection - Wheel Loader',
    version: 'SMS-MN-INS-0009_01',
    tabs: [
        {
        ...
        },
        {
            ...
            controls: [{
                ...
                controls:
                    [{
                        ...
                        pdf: { 1: [{ x: 181, y: 451, width: 387, height: 279 }] },
            ...
            },
            {
                ...
                controls:
                    [{
                        ...
                        pdf: { 1: [{ x: 181, y: 90, width: 387, height: 350 }] },
                        grid: { 1: [{ width: 387, height: 13, margin: 0.9 }] },
                        controls:
                            [{
                                param: 'name',
            ...
            },
            {
                ...
                controls:
                    [{
                        ...
                        pdf: { 2: [{ x: 186, y: 535, width: 387, height: 208 }] },
            ...
            },
            {
                ...
                controls:
                    [{
                        ...
                        pdf: { 2: [{ x: 186, y: 437, width: 387, height: 84 }] },
                        grid: { 2: [{ width: 387, height: 13, margin: 0.9 }] },
                        controls:
                            [{
                                param: 'name',
            ...
            },
            {
                ...
                controls:
                    [{
                        ...
                        pdf: { 2: [{ x: 186, y: 381, width: 387, height: 42 }] },
                        grid: { 2: [{ width: 387, height: 13, margin: 0.9 }] },
                        controls:
                            [{
                                param: 'name',
            ...
            {
                param: 'dropbox_collapse',
                type: ControlKeys.Collapse,
                label: 'Dropbox',
                controls:
                    [{
                        param: 'dropbox_checklist',
                        type: ControlKeys.Looper,
                        setLength: 4,
                        value: [{ 'name': 'Oil Level' }
                            , { 'name': 'Oil Leaks' }
                        ...
                        pdf: { 2: [{ x: 186, y: 311, width: 387, height: 56 }] },
                        grid: { 2: [{ width: 387, height: 13, margin: 0.9 }] },
                        controls:
                            [{
                                param: 'name',
            ...
            },
            {
                ...
                controls:
                    [{
                        ...
                        pdf: { 2: [{ x: 186, y: 173, width: 387, height: 112 }] },
                        grid: { 2: [{ width: 387, height: 13, margin: 0.9 }] },
                        controls:
                            [{
                                param: 'name',
            ...
            },
            {
                ...
                controls:
                    [{
                        ...
                        pdf: { 2: [{ x: 186, y: 105, width: 387, height: 56 }] },
                        grid: { 2: [{ width: 387, height: 13, margin: 0.9 }] },
                        controls:
                            [{
                                param: 'name',
            ...
            },
            {
                ...
                controls:
                    [{
                        ...
                        pdf: { 3: [{ x: 190, y: 660, width: 387, height: 84 }] },
                ...
                controls:
                    [{
                        ...
                        value: [{ 'name': 'Oscillation bearings' }
                            ...
                            , { 'name': 'Bucket Linkage Pins / Bushes' }
                            , { 'name': 'Quick Hitch / Pins / Safety Pin' }
                            , { 'name': 'Auto Greaser/Level/Lines' }
                        ],
                        pdf: { 3: [{ x: 190, y: 436, width: 387, height: 210 }] },
                        grid: { 3: [{ width: 387, height: 13, margin: 0.9 }] },
                        controls:
                            [{
                                param: 'name',
            ...
            },
            {
                ...
                controls:
                    [{
                        ...
                        pdf: { 3: [{ x: 190, y: 198, width: 387, height: 221 }] },
                        grid: { 3: [{ width: 387, height: 13, margin: 0.9 }] },
                        controls:
                            [{
                                param: 'name',
            ...
            },
            {
                ...
                controls:
                    [{
                        ...
                        pdf: { 3: [{ x: 190, y: 145, width: 387, height: 42 }] },
                        grid: { 3: [{ width: 387, height: 13, margin: 0.9 }] },
                        controls:
                            [{
                                param: 'name',
            ...
            },
            {
                ...
                controls:
                    [{
                        ...
                        pdf: { 4: [{ x: 190, y: 612, width: 387, height: 130 }] },
                        grid: { 4: [{ width: 387, height: 13, margin: 0.9 }] },
                        controls:
                            [{
                                param: 'name',
                                type: ControlKeys.TextLabel,
                    ...
                    },
                    {
                        ...
                        pdf: { 6: [{ x: 190, y: 96, width: 387, height: 31 }] },
                        grid: { 6: [{ width: 387, height: 15, margin: 0.9 }] },
                        controls:
                            [{
                                param: 'name',
                                type: ControlKeys.TextLabel,
                            },
                            {
                                ...
                                type: ControlKeys.Spinner,
                                controls: [
                                    { label: 'New', value: 'New', pdf: { x: 39 }, renderValue: true },
                                    { label: '< 50% Worn', value: '< 50% Worn', pdf: { x: 140 }, renderValue: true },
                                    { label: '> 50% Worn', value: '> 50% Worn', pdf: { x: 250 }, renderValue: true },
                                ],
                                pdf: { 6: [{ y: 0 }] },
                                radio: true,
                                required: true,
            ...
            {
                param: 'attachments_collapse',
                type: ControlKeys.Collapse,
                label: 'Attachments Supplied',
                controls:
                    [{
                        param: 'attachments_checklist',
                        type: ControlKeys.Looper,
                        maxLength: 4,
                        label: '+ Add Attachment',
                        pdf: { 4: [{ x: 60, y: 548, width: 130 + 387, height: 56 }] },
                        grid: { 4: [{ width: 130 + 387, height: 13, margin: 0.9 }] },
                        controls:
                            [{
                                param: 'name',
                                type: ControlKeys.TextField,
                            ...
                            },
                            {
                                ...
                                type: ControlKeys.Spinner,
                                controls: [
                                    { label: 'Pass', value: 'Pass', pdf: { x: 130 + 13 }, renderValue: true },
                                    { label: 'Fail', value: 'Fail', pdf: { x: 130 + 47 }, renderValue: true },
                                    { label: 'N/A', value: 'N/A', pdf: { x: 130 + 80 }, renderValue: true },
                                ],
                                pdf: { 4: [{ y: 0 }] },
                                radio: true,
                                required: true,
                ...
                controls:
                    [{
                        ...
                        value: [{ 'name': 'Fan Belt Guards' }
                            ...
                            , { 'name': 'Fire Suppression Shut Down Working', '{}': { height: 26 } }
                        ...
                        pdf: { 4: [{ x: 183, y: 160, width: 390, height: 363 }] },
                    ...
                    },
                    {
                        ...
                        type: ControlKeys.Looper,
                        maxLength: 4,
                        pdf: { 4: [{ x: 33, y: 90, width: 540, height: 56 }] },
            ...
            },
            {
                ...
                controls:
                    ...
                    },
                    {
                        ...
                        pdf: { 6: [{ x: 220, y: 185, width: 258, height: 108 }] },
                        grid: { 6: [{ width: 258, height: 14, margin: 4}] },
                        controls:
                            [{
                                param: 'name',
                                type: ControlKeys.TextLabel,
            ...
            },
            {
                ...
                controls:
                    ...
                    },
                    {
                        ...
                        type: ControlKeys.Looper,
                        setLength: 6,
                        pdf: { 7: [{ x: 208, y: 310, width: 582, height: 145 }, { x: 208, y: 203, width: 582, height: 92 }] },
            ...
            controls: [
                {
                    ...
                    value: [
                        ...
                        { label: { value: "Left Lift Cylinder", disabled: true } },
                        { label: { value: "Right Lift Cylinder", disabled: true } },
                        { label: { value: "Tilt Cylinder", disabled: true } },
