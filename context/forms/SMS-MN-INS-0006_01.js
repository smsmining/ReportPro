            ...
            controls: [
                {
                    ...
                    value: [
                        ...
                        { label: { value: "Left Boom Cylinder", disabled: true } },
                        { label: { value: "Right Boom Cylinder", disabled: true } },
                        { label: { value: "Left Stick Cylinder", disabled: true } },
                        { label: { value: "Right Stick Cylinder", disabled: true } },
                        { label: { value: "Left Bucket Cylinder", disabled: true } },
                        { label: { value: "Right Bucket Cylinder", disabled: true } },
                    ],
                    controls: [
                        {
                            param: 'header',
