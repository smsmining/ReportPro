            ...
            controls: [{
                    ...
                    controls:
                        [{
                            ...
                            pdf: { 1: [{ x: 186, y: 605, width: 387, height: 125 }] },
                        ...
                        },
                        {
                            ...
                            pdf: { 1: [{ x: 186, y: 480, width: 387, height: 126 }] },
                            grid: { 1: [{ width: 387, height: 13, margin: 0.9 }] },
                            controls:
                                [{
                                    param: 'name',
                ...
                },
                {
                    ...
                    controls:
                        [{
                            ...
                            pdf: { 1: [{ x: 186, y: 130, width: 387, height: 336 }] },
                            grid: { 1: [{ width: 387, height: 13, margin: 0.9 }] },
                            controls:
                                [{
                                    param: 'name',
                ...
                },
                {
                    ...
                    controls:
                        [{
                            ...
                            pdf: { 2: [{ x: 190, y: 576, width: 387, height: 168 }] },
                        ...
                        },
                        {
                            ...
                            pdf: { 2: [{ x: 190, y: 521, width: 387, height: 42 }] },
                            grid: { 2: [{ width: 387, height: 13, margin: 0.9 }] },
                            controls:
                                [{
                                    param: 'name',
                ...
                },
                {
                    ...
                    controls:
                        ...
                        },
                        {
                            ...
                            pdf: { 3: [{ x: 190, y: 187, width: 387, height: 154 }] },
                            grid: { 3: [{ width: 387, height: 13, margin: 0.9 }] },
                            controls:
                                [{
                                    param: 'name',
                ...
                },
                {
                    ...
                    controls:
                        [{
                            ...
                            type: ControlKeys.Looper,
                            setLength: 8,
                            pdf: { 4: [{ x: 132, y: 622, width: 440, height: 110 }] },
                ...
                },
                {
                    ...
                    controls:
                        [{
                            ...
                            pdf: { 4: [{ x: 183, y: 424, width: 390, height: 168 }] },
                        ...
                        },
                        {
                            ...
                            pdf: { 4: [{ x: 183, y: 214, width: 390, height: 196 }] },
                            grid: { 4: [{ width: 390, height: 14 }] },
                            controls:
                                [{
                                    param: 'name',
