            ...
            },
            {
                ...
                controls:
                    [{
                        ...
                        pdf: { 3: [{ x: 190, y: 354, width: 387, height: 198 }] },
                        grid: { 3: [{ width: 387, height: 13, margin: 0.9 }] },
                        controls:
                            [{
                                param: 'name',
            ...
            },
            {
                ...
                controls:
                    ...
                    },
                    {
                        ...
                        type: ControlKeys.Looper,
                        setLength: 6,
                        pdf: { 6: [{ x: 208, y: 378, width: 582, height: 145 }, { x: 208, y: 270, width: 582, height: 92 }] },
                        grid: { 6: [{ width: 97, height: 145 }, { width: 582, height: 15.2 }] },
                        controls:
                            [{
                                param: 'header',
                                type: ControlKeys.Divider,
            ...
            controls: [
                {
                    ...
                    value: [
                        ...
                        { label: { value: "Left Front Strut", disabled: true } },
                        { label: { value: "Right Front Strut", disabled: true } },
                        { label: { value: "Left Rear Strut", disabled: true } },
                        { label: { value: "Right Rear Strut", disabled: true } },
                        { label: { value: "Left Hoist Cylinder", disabled: true } },
                        { label: { value: "Right Hoist Cylinder", disabled: true } },
                        ...
                        { label: { value: "'No Gas in Struts' Tag on Key", disabled: true } },
                    ],
                    controls: [
                        {
                            param: 'header',
